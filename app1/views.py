...
def home(request):
    ...
    #if the parameter 'q' is not  equal to none then fetch that parameter else keep that parameter as an empty string
...
#     room=None #initially we assigned room value as None
#     for tasks in rooms:  #for loop is used to get the id and filter with dynamic url id
#         if(tasks['id']==int(pk)):
#             room=tasks
#     context={'room':room}
